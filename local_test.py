...
def get_arguments():
    ...
    parser.add_argument("--restore-from", type=str, default='snapshots/conresnet/ConResNet_5.pth',
...
def main():
    ...
    if os.path.exists(args.restore_from):
        ...
        #model.load_state_dict({k.replace('module.', ''): v for k, v in torch.load(args.restore_from).items()})
    else:
